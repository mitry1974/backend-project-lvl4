    ...
    flash: {
      ...
      tags: {
        delete: {
          ...
          errorLinkedTask: 'Ошибка удаления тэга, связанные задачи присутствуют',
        },
        create: {
          success: 'Тэг создан',
      ...
      users: {
        ...
        delete: {
          ...
          errorNotFound: 'Не удалось удалить пользователя, пользователь не найден',
          errorLinkedTask: 'Не удалось удалить пользователя, поскольку существуют связанные с ним задачи',
      ...
      taskStatuses: {
        ...
        delete: {
          ...
          errorLinkedTask: 'Ошибка удаления статуса задачи, связанные задачи присутствуют',
        },
      },
    },
    auth: {
